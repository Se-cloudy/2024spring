...
class MyEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.model_j = PPO.load("PPO_j_0122.zip")  # todo
    ...
    def step(self, action):
        ...
        action_jj[0] = 3 * (action_jj[0] + 1) * self.ActionBound_j[0] + self.f0 - 3 * self.B
...
if __name__ == "__main__":
    ...
    if train_mode:
        ...
        env = MyEnv()
        t_num = env.t_num
        model = PPO.load("./PPO_0122", env=env)  # PPO_u_0103
        dispNum = 100
