...
from UAVMEC.file0422.UAV_Env_0422 import UAV_env
...
if __name__ == '__main__':
    if If_Train:
        ...
        model = PPO('MlpPolicy', env, policy_kwargs=policy_kwargs, verbose=1, gamma=0.9, tensorboard_log="./PPO_tensorboard/")
