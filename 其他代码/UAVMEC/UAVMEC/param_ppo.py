...
from stable_baselines3 import DDPG, SAC, PPO, HER, DQN
...
reward_threshold = 3
timesteps = 5e6
study_name = 'UAV_user_scheduling'
...
result = open('D:/科研/Reinforcement_Learning_method/stable-baselines3-master/UAVMEC/top_layer/result.txt','a')
print(study.best_params, study.best_value, study.best_trial, file=result)
result.close()