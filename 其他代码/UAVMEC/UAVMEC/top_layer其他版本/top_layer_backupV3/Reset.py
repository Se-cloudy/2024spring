...
class Reset_Env(gym.Env):
    ...
    def reset(self):
        ...
        # self.state[8] = 10./Area_Bound
        # self.state[9] = 30./Area_Bound
        # self.state[10] = 20./Area_Bound
        # self.state[11] = 30./Area_Bound
        # self.state[12] = 30./Area_Bound
        # self.state[13] = 30./Area_Bound
        # self.state[14] = 30./Area_Bound
        # self.state[15] = 20./Area_Bound
        # self.state[16] = 30./Area_Bound
        # self.state[17] = 10./Area_Bound
        # self.state[18] = 30./Area_Bound
        # self.state[19] = 0./Area_Bound
