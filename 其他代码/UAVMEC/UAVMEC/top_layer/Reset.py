...
class Reset_Env(gym.Env):
    ...
    def reset(self):
        ...
        # self.state[0] = 15./Area_Bound
        # self.state[1] = 15./Area_Bound
        # self.state[2] = 15./Area_Bound
        # self.state[3] = 15./Area_Bound
        # self.state[4] = 15./Area_Bound
        # self.state[5] = 15./Area_Bound
        # self.state[6] = 15./Area_Bound
        # self.state[7] = 15./Area_Bound

        self.state[0] = 0. / Area_Bound
        self.state[1] = 0. / Area_Bound
        self.state[2] = 0. / Area_Bound
        self.state[3] = 30. / Area_Bound
        self.state[4] = 30. / Area_Bound
        self.state[5] = 30. / Area_Bound
        self.state[6] = 30. / Area_Bound
        self.state[7] = 0. / Area_Bound

        df_r = read_csv('User_Position_final.csv')
        for j in range(User_num):
            self.state[2*UAV_num + j*2] = df_r.iloc[j,0]*30/40
            self.state[2*UAV_num + j*2 + 1] = df_r.iloc[j,1]*30/40
