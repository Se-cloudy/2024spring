...
class TOP_ENV_DQN(gym.Env):
    ...
    def reset(self):
        ...
        T = np.random.uniform(0.6, T_max)
        E = np.random.uniform(100, E_max)
        self.state[2*(User_num+UAV_num)+User_num] = E/E_max
        self.state[2*(User_num+UAV_num)+User_num+1] = (T_max-T)/T_max
    ...
    def step(self, action):
        ...
        for time in range(N+1):
            ...
            if dones:
                ...
                Total_reward = (1 - Total_Com_Energy/100)  # 这个是R2部分的得分
